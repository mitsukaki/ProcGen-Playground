...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 18592,
    DYNAMIC_BASE = 5261472,
    DYNAMICTOP_PTR = 18432;
...
var wasmBinaryFile = 'mesher.wasm';
...
/** @type {function(...*):?} */
var _GetPtrSize = Module["_GetPtrSize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GetPtrSize"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _GenerateMesh = Module["_GenerateMesh"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["GenerateMesh"].apply(null, arguments)
};
